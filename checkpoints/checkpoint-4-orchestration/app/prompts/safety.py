"""Safety system prompt used by the LangGraph ReAct agent.

Pinned at the top of every conversation so the model stays on task and
declines obvious override attempts even when the regex check misses.
"""
